    ...
    <div class="flex h-[100vh] flex-col items-center justify-center gap-10">
        ...
        <div class="text-sm font-normal">
            @lang('admin::app.components.layouts.powered-by.description', [
                'krayin' => '<a class="text-brandColor hover:underline " href="https://agenciataruga.com/">Agência Taruga</a>',
                'webkul' => '<a class="text-brandColor hover:underline " href="https://runcrm.com.br/">RunCRM</a>',
            ]) 
        </div>
    </div>
